...
final continents=[
  ContinentModel(name: "Asia", image: "assets/asia.jpg", color: constant.Constant.darkYellow),
  ...
  ContinentModel(name: "Oceania", image: "assets/australia.jpg", color: constant.Constant.skyBlue),
];